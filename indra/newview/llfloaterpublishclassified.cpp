 ...
 * @brief Floater to confirm classified ad publish
 *
...
LLFloaterPublishClassified::LLFloaterPublishClassified(const LLSD& key) : LLFloater(key) {}

LLFloaterPublishClassified::~LLFloaterPublishClassified() {}
...
void LLFloaterPublishClassified::setPrice(S32 price) { getChild<LLUICtrl>("price_for_listing")->setValue(price); }

S32 LLFloaterPublishClassified::getPrice() { return getChild<LLUICtrl>("price_for_listing")->getValue().asInteger(); }
