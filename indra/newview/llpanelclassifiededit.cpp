...
BOOL LLPanelClassifiedEdit::postBuild()
{
    ...
    for (iter = LLClassifiedInfo::sCategories.begin(); iter != LLClassifiedInfo::sCategories.end(); iter++)
    {
...
void LLPanelClassifiedEdit::resetControls()
{
    ...
    {
        getChild<LLUICtrl>("price_for_listing")->setValue(MINIMUM_PRICE_FOR_CLASSIFIED_LISTING);
    }
