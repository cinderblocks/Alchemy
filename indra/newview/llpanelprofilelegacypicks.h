/** 
 * @file llpanelprofilelegacypicks.h
 * @brief LLPanelProfileLegacyPicks and related class definitions
 *
...
#ifndef LL_LLPANELPROFILELEGACYPICKS_H
#define LL_LLPANELPROFILELEGACYPICKS_H
...
class LLPanelProfileLegacyPicks final
	: public LLPanelProfileLegacyTab
{
    friend class LLPanelProfileLegacy;

  public:
	LLPanelProfileLegacyPicks();
	~LLPanelProfileLegacyPicks() override;
...
#endif // LL_LLPANELPROFILELEGACYPICKS_H
